package com.mahrus.bantuaku.mahrusdraw._sliders;
...
import com.mahrus.bantuaku.mahrusdraw.HomeFragment;
...
public class SliderIndicator implements ViewPager.OnPageChangeListener {
    ...
    public SliderIndicator(@NonNull FragmentActivity context,
